...
<i class="fa fa-trash fa-lg"></i>
    ...
    //! Ekrana bastirmanin ikinci yolu
    //<p>${todoInput.value}</p>;
    ...
    todoInput.value = "";
    //? Her li girisinde cursor input un icimde olsun
    todoInput.focus();
  }

  //!silme metodu, ekrana basıldığı süslü de (add butonuna basilma süslüsünde, func.scope) olmalı, dışarıda fa-trash lara tıklayınca, remove mantıklı değil, ortada fa-trash daha oluşmadan (add butonuna basılmadan) js ye çağırmak gibi oluyor
